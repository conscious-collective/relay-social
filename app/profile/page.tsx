    ...
    <div>
      ...
      <div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 font-mono text-sm">
          <p className="text-zinc-400"># Schedule a post via API</p>
          <p>curl -X POST https://relay-social.pages.dev/api/posts \</p>
          <p className="pl-4">-H &quot;Authorization: Bearer YOUR_JWT_TOKEN&quot; \</p>
